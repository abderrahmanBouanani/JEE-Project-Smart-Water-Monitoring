...
Le système Smart Water Monitoring adopte une \textbf{architecture monolithique en trois couches} basée sur le patron Modèle-Vue-Contrôleur (MVC), implémenté avec Jakarta EE (anciennement Java EE).
...
\begin{figure}[ht]
    \centering
    \includegraphics[width=0.95\linewidth]{figures/WMS_class_diagram}
