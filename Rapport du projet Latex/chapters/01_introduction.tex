...
\begin{description}
    ...
    \item[Chapitre 3 -- Analyse des besoins fonctionnels :] Décrit les besoins fonctionnels et non fonctionnels du système, ainsi que les cas d'utilisation identifiés.
    
    \item[Chapitre 4 -- Conception et réalisation :] Expose l'architecture globale du système, les diagrammes UML (classes, séquence, déploiement), les choix de conception et présente les aspects techniques de l'implémentation.
    
    \item[Conclusion et perspectives :] Synthétise les réalisations du projet, évalue l'atteinte des objectifs et propose des pistes d'amélioration future.
    
    \item[Annexes :] Contiennent les informations complémentaires, les codes sources et les documents techniques de référence.
\end{description}
